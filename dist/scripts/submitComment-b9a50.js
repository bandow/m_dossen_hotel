...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_sass_submitComment_scss__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_plugins_swiper_3_4_2_min_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_plugins_swiper_3_4_2_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__src_plugins_swiper_3_4_2_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_plugins_swiper_3_4_2_min_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_plugins_swiper_3_4_2_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__src_plugins_swiper_3_4_2_min_js__);
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(document).ready(function () {
	//选择星星
	var bigStar = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".big-star li");
	var index = 0;
	for (var i = 0; i < bigStar.length; i++) {
		...
		bigStar[i].onclick = function () {
			...
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".room-info h2,.room-info p").hide();
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".select-name").hide();
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".room-info").css({ 'padding': '5%' });
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".room-info i").css({
				'margin': '0 auto',
				'width': '3rem',
				'height': '3rem'
			});
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".tag-comment").show();
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".btn").show();
			...
			__WEBPACK_IMPORTED_MODULE_2_jquery___default.a.ajax({
				...
				success: function (data) {
					...
					result += '</ul>';
					__WEBPACK_IMPORTED_MODULE_2_jquery___default()('.title-tag').html(result);

					__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".title-tag li").on("click", function () {
						__WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).toggleClass("active");
						if (__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".title-tag .active").length == 0) {
							__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".btn").removeClass("active").find("a").attr("scr", "javascript:;");
						} else {
							__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".btn").addClass("active").find("a").attr("scr", "#123");
						}
					});
				},
	...
	//选择匿名评论
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".select-name").on("click", function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).toggleClass("active");
		if (__WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).hasClass("active")) {
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".select-comment p em").text("bandiw");
		} else {
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".select-comment p em").text("匿名");
		}
	});
	...
	/*点击图片的文本框*/
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".file").change(function () {
		var idFile = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).attr("id");
		var file = document.getElementById(idFile);
		var imgContainer = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).parents(".z_photo"); //存放图片的父亲元素
		var fileList = file.files; //获取的图片文件
		console.log(fileList + "======filelist=====");
		var input = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).parent(); //文本框的父亲元素
		var imgArr = [];
		//遍历得到的图片文件
		...
		if (fileList.length > 5 || totalNum > 5) {
			...
			for (var i = 0; i < fileList.length; i++) {
				...
				imgArr.push(imgUrl);
				var $section = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<section class='up-section fl loading'>");
				imgContainer.prepend($section);
				var $span = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<span class='up-span'>");
				$span.appendTo($section);

				var $img0 = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<img class='close-upimg'>").on("click", function (event) {
					event.preventDefault();
					event.stopPropagation();
					__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".works-mask").show();
					delParent = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).parent();
				});

				$section.on("click", function () {
					__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".mask").fadeIn();
					__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".delete").show();
					__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".page-album-info").addClass("on");
				});
				// $img0.attr("src","../dist/images/hotelinfo_close-f49c1.png").appendTo($section);
				var $img = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<img class='up-img up-opcity'>");
				$img.attr("src", imgArr[i]);
				$img.appendTo($section);
				var $p = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<p class='img-name-p'>");
				$p.html(fileList[i].name).appendTo($section);
				var $input = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<input id='taglocation' name='taglocation' value='' type='hidden'>");
				$input.appendTo($section);
				var $input2 = __WEBPACK_IMPORTED_MODULE_2_jquery___default()("<input id='tags' name='tags' value='' type='hidden'/>");
				$input2.appendTo($section);
			}
		}
		setTimeout(function () {
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".up-section").removeClass("loading");
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".up-img").removeClass("up-opcity");
		}, 450);
		numUp = imgContainer.find(".up-section").length;
		if (numUp >= 5) {
			__WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).parent().hide();
		}
	...
	//点击覆盖层
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".mask").on("click", function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".mask").fadeOut();
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".page-album-info").removeClass("on");
	});
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".delete").on("click", function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".swiper-slide:eq(0)").remove();
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".swiper-pagination-total").text(__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".swiper-pagination-total").text() - 1);
	});

	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".z_photo").delegate(".close-upimg", "click", function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".works-mask").show();
		delParent = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).parent();
	});

	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".wsdel-ok").click(function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".works-mask").hide();
	...
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".wsdel-no").click(function () {
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".works-mask").hide();
	});
	...
	function validateUp(files) {
		...
		for (var i = 0, file; file = files[i]; i++) {
			...
			if (newStr.split(".")[0] != null) {
				...
				if (__WEBPACK_IMPORTED_MODULE_2_jquery___default.a.inArray(type, defaults.fileType) > -1) {
					// 类型符合，可以上传
