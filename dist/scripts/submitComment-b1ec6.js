...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(document).ready(function () {
	...
	//点击相册列表
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".img-list li").on("click", function () {
	...
	//点击切换回复
	__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".reply-change").on("click", function () {
		// $(this).toggleClass("on").parent().next().slideToggle();
		__WEBPACK_IMPORTED_MODULE_2_jquery___default()(this).toggleClass("on").parent().next().slideToggle();
	});
