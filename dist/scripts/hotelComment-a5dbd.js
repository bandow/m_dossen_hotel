...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_sass_hotelComment_scss__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_sass_hotelComment_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__src_sass_hotelComment_scss__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_plugins_dropload_css__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_plugins_dropload_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__src_plugins_dropload_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_plugins_zepto_min_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_plugins_zepto_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__src_plugins_zepto_min_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_plugins_dropload_min_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_plugins_dropload_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__src_plugins_dropload_min_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_plugins_swiper_3_4_2_min_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_plugins_swiper_3_4_2_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__src_plugins_swiper_3_4_2_min_js__);
...
var Zepto = function () {
  function L(t) {
    ...
    var n,
        r,
        o,
        i = [];if (M(t)) for (r = 0; r < t.length; r++) n = e(t[r], r), null != n && i.push(n);else for (o in t) n = e(t[o], o), null != n && i.push(n);return z(i);
  }, n.each = function (t, e) {
    var n, i;if (M(t)) {
    ...
    j["[object " + e + "]"] = e.toLowerCase();
      ...
      var i = this[0],
          r = !1;for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : T.matches(i, t));) i = i !== e && !_(i) && i.parentNode;return n(i);
    }, parents: function (t) {
  ...
  function l(e, n, i) {
    ...
    var n = t.extend({}, e || {}),
        o = t.Deferred && t.Deferred();for (i in t.ajaxSettings) void 0 === n[i] && (n[i] = t.ajaxSettings[i]);p(n), n.crossDomain || (n.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(n.url) && RegExp.$2 != window.location.host), n.url || (n.url = window.location.toString()), E(n);var s = n.dataType,
    ...
    }, m(d, n) === !1) return d.abort(), v(null, "abort", d, n, o), d;if (n.xhrFields) for (r in n.xhrFields) d[r] = n.xhrFields[r];var S = "async" in n ? n.async : !0;d.open(n.type, n.url, S, n.username, n.password);for (r in f) y.apply(d, f[r]);return n.timeout > 0 && (j = setTimeout(function () {
  ...
  t.fn.serializeArray = function () {
    var e,
      ...
      e = t(this), n = e.attr("type"), "fieldset" != this.nodeName.toLowerCase() && !this.disabled && "submit" != n && "reset" != n && "button" != n && ("radio" != n && "checkbox" != n || this.checked) && i.push({ name: e.attr("name"), value: e.val() });
    }), i;
